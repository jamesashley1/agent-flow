...
Native macOS app for real-time visualization of Claude Code and OpenAI Codex agent sessions. This works with both CLI sessions and Xcode Coding Assistant sessions. Watch agents think, branch, call tools, and coordinate — rendered as an interactive node graph with multiple visual themes.
